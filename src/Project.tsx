...
export default function Project() {
  ...
  // ✅ hard guard (fixes indexing error completely)
  if (!id || !(id in projects)) {
    return <div className="p-10">Not Found</div>;
  }

  // ✅ fully safe access
  const project = projects[id as keyof typeof projects] as Project;
      ...
      <div className="max-w-5xl mx-auto">
        ...
        {project.demo && (
          <div className="mt-20 p-6 bg-gray-50 border border-gray-200 rounded-xl">
            ...
            <h3 className="font-semibold mb-5">Explore the System</h3>

            <div className="mb-6 text-sm">
              <p className="font-medium mb-3 text-gray-900">Access</p>
  ...
  >
    ...
    <span className="text-gray-400">↗</span>
            ...
            <div className="space-y-3 text-sm text-gray-700">
              {project.demo.steps.map((step: string, i: number) => (
        ...
        <div className="mt-16 flex flex-wrap gap-4">
          ...
          {project.github && (
            <a href={project.github} target="_blank">
              <button className="px-5 py-2.5 border border-gray-300 rounded-lg text-sm">
                GitHub
              </button>
            </a>
          )}
